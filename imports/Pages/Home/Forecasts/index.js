...
const panes = [
  ...
  { menuItem: 'Precipitation', render: ({ Forecasts }) => <PrecipitationForecast Forecasts={Forecasts} /> },
  { menuItem: 'Wind', render: ({ Forecasts }) => <WindForecast Forecasts={Forecasts} /> },
{ menuItem: 'Humidity', render: ({ Forecasts }) => <HumidityForecast Forecasts={Forecasts} />},
