...
const dayAverage = (day, format = "hh a") => {
  return {
    chance: round(day.forecast.reduce((total, hour, counter) => {
  ...
  return (<div>
    ...
    <div>
      ...
      <LineChart width={containerWidth} height={height} data={flatten(Forecasts)[0]} margin={{
        ...
        <XAxis dataKey="date"/>
        <YAxis>
          <Label value="mm" angle={-90} position="Left"/>
        </YAxis>
        ...
        <Line type="monotone" dataKey="amount" stroke="#3498db" activeDot={{
            r: 8
          }}/>
      </LineChart>
    </div>
    ...
    <div>
      ...
      <LineChart width={containerWidth} height={height} data={flattenAllDays(Forecasts)} margin={{
        ...
        <Line type="monotone" dataKey="chance" stroke="#3498db" activeDot={{
            r: 1
          }} dot={false}/>
      </LineChart>
    </div>
